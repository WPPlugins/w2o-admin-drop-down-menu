...
function wp_w2oadm_css() {
	...
	echo "<link rel='stylesheet' href='{$plugin}w2oadm.css.php?$query' type='text/css' media='all' w2oadm='www.w2orange.com' />\n
	<link rel='stylesheet' href='{$plugin}w2oadm.responsive.css.php?$query' type='text/css' media='all' w2oadm='www.w2orange.com' />\n
	";
}
...
function wp_w2oadm_dynamic_styles() {
	...
	if(count($_wp_admin_css_colors)>0) {
		...
		echo '<style type="text/css" w2oadm="www.w2orange.com">
...
// To add Admin Color Scheme called "W2orange"
function wp_w2o_admin_color_scheme () {
	global $wp_w2oadm;
		
	$suffix = is_rtl() ? '-rtl' : '';
	wp_admin_css_color(
		'w2orange', __( 'W2orange', 'admin_schemes' ),
